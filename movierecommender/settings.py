...
SECRET_KEY = 'ebph*!6jb8!kxw^s0=e2=(vo46v@mqf-e*ak#v+ksj*kjud)c%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['movie-recommender-korhanyuzbas.herokuapp.com']
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://165.227.238.244:6379/1",
        "OPTIONS": {
